...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    $(document).ready(function() {
        ...
        d = new ScrollMagic.Controller(), d.scrollTo(function(a) {
            ...
            offset: 70
        }).setClassToggle(".site-wrapper", "header-fixed").addTo(a), f = new ScrollMagic.Controller(), 
        e = document.getElementById("video-on-scroll"), e && (c = videojs("video-on-scroll"), 
        c.controls(!1), g = new ScrollMagic.Scene({
