...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    $(document).ready(function() {
        var a, b, c, d, e, f, g;
        f = document.getElementById("videocover"), f && (d = videojs("videocover"), d.controls(!1)), 
        $(".disable-anchors a").click(function(a) {
        ...
        }), g = $(window).width(), b = $("[data-responsive-bg-img]"), e = {
            screenPhone: 480,
            screenTablet: 960,
            screenDesktop: 960,
            ...
            var d;
            switch (d = $(b).data("responsive-bg-img"), console.log(d), !0) {
              case g <= e.screenPhone:
                c(b, d["vw-phone"]);
                break;

              case g <= e.screenTablet && g > e.screenPhone:
                c(b, d["vw-tablet"]);
                break;

              case g <= e.screenDesktop && g > e.screenTablet:
                c(b, d["vw-desktop"]);
                break;

              case g > e.screenLargeDesktop:
                c(b, d["vw-lg-desktop"]);
            }
    ...
    $(document).ready(function() {
        ...
        e = new ScrollMagic.Controller(), e.scrollTo(function(a) {
            ...
            offset: 70
        }).setClassToggle(".site-wrapper", "header-fixed").addTo(a), g = new ScrollMagic.Controller(), 
        f = document.getElementById("video-on-scroll"), i = !1, d = 0, f && (c = videojs("video-on-scroll"), 
        c.controls(!1), c.load(), h = new ScrollMagic.Scene({
            triggerElement: ".video-on-scroll",
            duration: $(window).height()
        }).addTo(g), h.on("enter", function() {
            i ? (c.currentTime(d), c.play()) : (c.currentTime(240), c.play(), i = !0);
        }), h.on("leave", function() {
